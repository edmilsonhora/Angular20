...
namespace MyAngular20.AppWebAngular.Controllers
{
    ...
    public class MateriasController : ControllerBase
    {
        ...
        public MateriasController(IFacade facade)
        {
            this._facade = facade;
        }
        ...
        public IActionResult ObterTodos()
        {
            try
            {
                return Ok(_facade.Materias.ObterTodos());
            }
            catch (Exception ex)
            {
                _facade.Roolback();
        ...
        public IActionResult ObterPor(int id)
        {
            try
            {
                return Ok(_facade.Materias.ObterPor(id));
            }
            catch (Exception ex)
            {
                _facade.Roolback();
        ...
        public IActionResult Salvar(MateriaView view)
        {
            try
            {
                _facade.Materias.Salvar(view);
                _facade.SaveChanges();
                return Ok(true);
            }
            catch (Exception ex)
